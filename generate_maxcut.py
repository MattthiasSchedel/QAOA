...
def generate_maxcut(num_nodes: int, num_edges: int, weights=False):
    problem_generator = ProblemGenerator()
    problem = problem_generator.generate_maxcut(num_nodes, num_edges, weights=weights)
    return problem

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Generate a Maxcut problem')
    ...
    problem = generate_maxcut(num_nodes, num_edges, weights)
